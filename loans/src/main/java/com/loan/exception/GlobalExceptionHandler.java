...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseVo> handleResourceNotFoundException(ResourceNotFoundException exception,
                                                                            WebRequest webRequest) {
    	ErrorResponseVo errorResponseDTO = new ErrorResponseVo(
                webRequest.getDescription(false),
    ...
    public ResponseEntity<ErrorResponseVo> handleLoanAlreadyExistsException(LoanAlreadyExistsException exception,
                                                                             WebRequest webRequest){
        ErrorResponseVo errorResponseDTO = new ErrorResponseVo(
                webRequest.getDescription(false),
