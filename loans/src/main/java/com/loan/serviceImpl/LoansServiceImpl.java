...
public class LoansServiceImpl implements ILoansService {
     ...
     */
    @Override
    public LoansVo fetchLoan(String mobileNumber) {
        Loans loans = loansRepository.findByMobileNumber(mobileNumber).orElseThrow(
                () -> new ResourceNotFoundException("Loan", "mobileNumber", mobileNumber)
        );
        return LoansMapper.mapToLoansDto(loans, new LoansVo());
    }
     ...
     */
    @Override
    public boolean updateLoan(LoansVo loansVo) {
        Loans loans = loansRepository.findByLoanNumber(loansVo.getLoanNumber()).orElseThrow(
                () -> new ResourceNotFoundException("Loan", "LoanNumber", loansVo.getLoanNumber()));
        LoansMapper.mapToLoans(loansVo, loans);
